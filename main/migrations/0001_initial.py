# Generated by Django 4.1 on 2022-08-16 02:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Tbfarminsubconstocks',
            fields=[
                ('recordid', models.BigAutoField(db_column='recordID', primary_key=True, serialize=False)),
                ('itmcd', models.CharField(db_column='ITMCD', max_length=11)),
                ('fqty', models.IntegerField(db_column='FQTY')),
            ],
            options={
